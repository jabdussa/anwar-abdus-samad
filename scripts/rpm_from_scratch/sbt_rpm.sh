...
mkdir -p $TMP/ROOT/opt/local/sbt/bin

install -m 755 $TMP/sbt/bin/sbt  $TMP/ROOT/opt/local/sbt/bin
install -m 755 $TMP/sbt/bin/sbt.bat  $TMP/ROOT/opt/local/sbt/bin
install -m 755 $TMP/sbt/bin/sbt-launch.jar  $TMP/ROOT/opt/local/sbt/bin
install -m 755 $TMP/sbt/bin/sbt-launch-lib.bash  $TMP/ROOT/opt/local/sbt/bin
